            ...
            <div class="d-flex flex-column h-100 overflow-hidden rounded-3" style="background-color: #f6f8fb;">
                <div class="d-flex justify-content-between px-grid-gutter py-grid-gutter">
                    <div class="order-md-2">
                        ...
                        <a class="fs-md" href="shop-grid-ls.html">Shop for men<i class="ci-arrow-right fs-xs align-middle ms-1"></i></a>
                    </div>
                ...
                <a class="d-none d-md-block mt-auto" href="shop-grid-ls.html"><img class="d-block w-100" src="img/home/categories/cat-lg01.jpg" alt="For Men"></a>
            </div>
        </div>
                        ...
                        <div class="row mx-n2">
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">Hats &amp; Caps</a>
                            ...
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">T-shirts</a>
                            ...
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">Accessories</a>
                            ...
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">Shoes</a>
                            ...
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4 d-none d-lg-block">
                                <div class="card product-card card-static">
                                    <span class="badge badge-info badge-shadow">Popular</span>
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">Bags</a>
                        ...
                        <div class="row mx-n2">
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">Sandals</a>
                            ...
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">Shorts</a>
