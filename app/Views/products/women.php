            ...
            <div class="d-flex flex-column h-100 overflow-hidden rounded-3" style="background-color: #f6f8fb;">
                <div class="d-flex justify-content-between px-grid-gutter py-grid-gutter">
                    <div>
                        ...
                        <a class="fs-md" href="shop-grid-ls.html">Shop for women<i class="ci-arrow-right fs-xs align-middle ms-1"></i></a>
                    </div>
                ...
                <a class="d-none d-md-block mt-auto" href="shop-grid-ls.html"><img class="d-block w-100" src="img/home/categories/cat-lg02.jpg" alt="For Women"></a>
            </div>
        </div>
                        ...
                        <div class="row mx-n2">
                            ...
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">Blouse</a>
                            ...
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2">
                                        <a class="product-meta d-block fs-xs pb-1" href="#">Sportswear</a>
