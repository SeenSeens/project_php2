            ...
            <div class="row pt-4">
                <div class="col-md-4 col-sm-6 mb-grid-gutter">
                    <div class="card border-0 shadow">
                        <img class="card-img-top" src="<?= __WEB_ROOT__ ?>/public/frontend/img/contacts/orlando.jpg" alt="Orlando">
                        <div class="card-body">
                            <h6>Orlando, USA</h6>
                ...
                <div class="col-md-4 col-sm-6 mb-grid-gutter">
                    <div class="card border-0 shadow">
                        <img class="card-img-top" src="<?= __WEB_ROOT__ ?>/public/frontend/img/contacts/chicago.jpg" alt="Chicago">
                        <div class="card-body">
                            <h6>Chicago, USA</h6>
                            <ul class="list-unstyled mb-0">
                                <li class="d-flex pb-3 border-bottom">
                ...
                <div class="col-md-4 col-sm-12 mb-grid-gutter">
                    <div class="card border-0 shadow">
                        <img class="card-img-top" src="<?= __WEB_ROOT__ ?>/public/frontend/img/contacts/newyork.jpg" alt="New York">
                        <div class="card-body">
                            <h6>New York, USA</h6>
                            <ul class="list-unstyled mb-0">
                                <li class="d-flex pb-3 border-bottom">
