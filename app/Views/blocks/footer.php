            ...
            <div class="row pb-2">
                <div class="col-md-6 text-center text-md-start mb-4">
                    <div class="text-nowrap mb-4">
                        <a class="d-inline-block align-middle mt-n1 me-3" href="#"><img class="d-block" src="<?= __WEB_ROOT__ ?>/public/frontend/img/footer-logo-light.png" width="117" alt="Cartzilla"></a>
                        <div class="btn-group dropdown disable-autohide">
                            <button class="btn btn-outline-light border-light btn-sm dropdown-toggle px-2" type="button" data-bs-toggle="dropdown"><img class="me-2" src="<?= __WEB_ROOT__ ?>/public/frontend/img/flags/en.png" width="20" alt="English">Eng / $</button>
                            <ul class="dropdown-menu my-1">
                                ...
                                <li><a class="dropdown-item pb-1" href="#"><img class="me-2" src="<?= __WEB_ROOT__ ?>/public/frontend/img/flags/fr.png" width="20" alt="Français">Français</a></li>
                                <li><a class="dropdown-item pb-1" href="#"><img class="me-2" src="<?= __WEB_ROOT__ ?>/public/frontend/img/flags/de.png" width="20" alt="Deutsch">Deutsch</a></li>
                                <li><a class="dropdown-item" href="#"><img class="me-2" src="<?= __WEB_ROOT__ ?>/public/frontend/img/flags/it.png" width="20" alt="Italiano">Italiano</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-6 text-center text-md-end mb-4">
                    ...
                    <img class="d-inline-block" src="<?= __WEB_ROOT__ ?>/public/frontend/img/cards-alt.png" width="187" alt="Payment methods">
                </div>
            </div>
